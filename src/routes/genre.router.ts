...
router.post('/', genreValidator, async (req: Request, res: Response) => {
...
router.put('/:name', genreValidator, async (req: Request, res: Response) => {
  const errors = validationResult(req);
...
router.delete('/:name', async (req: Request, res: Response) => {
  ...
  try {
    const deletedGenre = await GenreModel.findOneAndDelete({
      name: decodedName,
    });
